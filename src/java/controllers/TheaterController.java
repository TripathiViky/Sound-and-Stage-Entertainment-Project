...
@WebServlet(name = "TheaterController", urlPatterns = {"/TheaterController"})
public class TheaterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TheaterController</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            String result=obt.insert();
            result+="<hr/>";
            result+=obt.getRecords();
