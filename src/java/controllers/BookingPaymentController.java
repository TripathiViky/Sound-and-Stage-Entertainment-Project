...
@WebServlet(name = "BookingPaymentController", urlPatterns = {"/BookingPaymentController"})
public class BookingPaymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BookingPaymentController</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            oblogger.insertFromWebpage(hs, "bookingpayment,"+bookingcode+","+amount);
            
            RequestDispatcher rd=request.getRequestDispatcher("pos/BookingPayment4.jsp");
