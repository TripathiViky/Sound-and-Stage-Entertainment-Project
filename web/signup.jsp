<%-- 
    Document   : signup
    Created on : 28 Jun, 2018, 1:01:55 PM
    Author     : Vikas
--%>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <form method="post" action="UserMasterController" style="max-width:500px;margin:auto">
        <center><h2>Register Now</h2></center>
  <div class="input-container5">
    <i class="fa fa-user icon"></i>
  <input class="input-field5" type="text" placeholder="Name" name="txtname">
  </div>

  <div class="input-container5">
    <i class="fa fa-user icon"></i>
    <input class="input-field5" type="text" placeholder="Username"name="txtusername">
  </div>
  
  <div class="input-container5">
    <i class="fa fa-envelope icon"></i>
    <input class="input-field5" type="text" placeholder="PhoneNumber"name="txtphone">
  </div>
        
        <input type="hidden" name="sname" value="2">
        
  <div class="input-container5">
    <i class="fa fa-key icon"></i>
<input class="input-field5" type="password" placeholder="Password"name="txtpassword">
  </div>

        
  <button type="submit" class="btn5">Register</button>
</form><br>
