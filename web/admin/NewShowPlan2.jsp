<%-- 
    Document   : NewShowPlan2
    Created on : 24 Jun, 2018, 3:27:59 AM
    Author     : Vikas
--%>
...
<jsp:useBean id="obh" class="models.HallModel" />
        ...
        <%
            ...
            %>
        <form name="frm1" method="post" action="NewShowPlan.jsp">
            <table id="maintable" align="center" >
                <tr><td>Select Hall:</td><td> <%= obh.getComboByTheaterCode("cmbhallcode", theatercode) %></td>
                </tr>
                <tr>
                    <td>Select Date: </td>
                    <td><input type="text" id="datepicker" name="txtplandate" placeholder="MM/DD/YYYY" required/></td>
                </tr>
                <tr>
                    <td>Start Time: </td>
                    <td><input type="text" name="txtstarttime" placeholder="HH.MM" required /></td>
                </tr>
                <tr>
                    <td>End Time: </td>
                    <td><input type="text" name="txtendtime" placeholder="HH.MM" required/></td>
                </tr>
                <tr>
                    <td>Select Movie</td>
                    <td><%= obm.getCombo("cmbmoviecode") %></td>
                </tr>
                <tr><td colspan="2"><input type="submit" value="Create Plan"/></td></tr>
            </table>
        </form>
</div>
</center>
