      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="NewHall.jsp">Edit</a></li>
            <li><a href="NewHall.jsp">Delete</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="NewSeat.jsp">Edit</a></li>
            <li><a href="NewSeat.jsp">Delete</a></li>  
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="NewShowPlan.jsp">Edit</a></li>
            <li><a href="NewShowPlan.jsp">Delete</a></li>  
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="NewMovie1.jsp">Edit</a></li>
            <li><a href="NewMovie1.jsp">Delete</a></li> 
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="NewSnack1.jsp">Edit</a></li>
            <li><a href="NewSnack1.jsp">Delete</a></li> 
          </ul>
        </li>
...
<form method="post" action="../ChangePasswordController">
            <table id="maintable" align="center" border="0" >
                <tr>
                    ...
                    <td><input type="text" name="txtoldpassword"/><br></td>
                </tr>
                <tr>  
                    <td><br>Enter New Password :</td>
                    <td><br><input type="text" name="txtpassword"/><br></td>
                </tr>
                
                <tr>
                    <td colspan="2" align="center"><br><input type="submit" value="Confirm"/><br></td>
                </tr>
            </table>
        </form>
</div>
