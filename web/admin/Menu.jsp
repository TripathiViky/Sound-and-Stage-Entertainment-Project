<%-- 
    Document   : menu
    Created on : 23 Jun, 2018, 4:11:15 PM
    Author     : Vikas
--%>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="admin/ChangePassword.jsp">Change Password</a></li>
            <li><a href="admin/RegisterPOS.jsp">Register POS</a></li>
            <li><a href="admin/ViewLogByUser.jsp">Log Records</a></li>
        ...
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="admin/NewTheatre.jsp">Add</a></li>
            <li><a href="admin/NewTheatre.jsp">Edit</a></li>
            <li><a href="admin/NewTheatre.jsp">Delete</a></li>  
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="admin/NewHall.jsp">Add</a></li>
            <li><a href="admin/NewHall.jsp">Edit</a></li>
            <li><a href="admin/NewHall.jsp">Delete</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="admin/NewSeat.jsp">Add</a></li>
            <li><a href="admin/NewSeat.jsp">Edit</a></li>
            <li><a href="admin/NewSeat.jsp">Delete</a></li>  
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="admin/NewShowPlan1.jsp">Add</a></li>
            <li><a href="admin/NewShowPlan1.jsp">Edit</a></li>
            <li><a href="admin/NewShowPlan1.jsp">Delete</a></li>  
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="admin/NewMovie1.jsp">Add</a></li>
            <li><a href="admin/NewMovie1.jsp">Edit</a></li>
            <li><a href="admin/NewMovie1.jsp">Delete</a></li> 
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="admin/NewSnack1.jsp">Add</a></li>
            <li><a href="admin/NewSnack1.jsp">Edit</a></li>
            <li><a href="admin/NewSnack1.jsp">Delete</a></li> 
          </ul>
        </li>
...
<div class="container1">
  ...
  <div class="middle1">
    <div class="text1"><a href="infinitywar.html">Book</a>
    </div>
  </div>
</div>
  </div>
