...
<div class="forum1">
        ...
        <form action="../TheaterController" >
            <table id="maintable" align="center" >
              ...
              <tr>
                    <td><br>Theater Location :</td>
                    <td><br><input type="text" name="txtlocation" required/></td>
                </tr>
                <tr>
                    
                    <td colspan="2" align="center"><br><input type="submit" value="Register"/></td>
                </tr>
