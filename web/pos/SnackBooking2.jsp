<%-- 
    Document   : SnackBooking2
    Created on : 1 Jul, 2018, 12:56:44 AM
    Author     : Vikas
--%>
...
<% 
            ...
            <form method="post" action="../BookingSnackTempController">
             ...
             <br/>
                  ...
                  <form name='form1' method='post' action='SnackPayment.jsp'>
                  <input type='submit' name='btnsubmit' value='Proceed to Pay' />
                  </form>
