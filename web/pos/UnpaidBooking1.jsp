<%-- 
    Document   : UnpaidBooking1
    Created on : 1 Jul, 2018, 12:49:45 AM
    Author     : Vikas
--%>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="SnackBooking1.jsp">Snack</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="BookingPayment1.jsp">Collect Payment</a></li>
            <li><a href="UnpaidBooking1.jsp">Unpaid Status</a></li>
            <li><a href="CancelBooking1.jsp">Cancel</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="PrintBill1.jsp">Movie</a></li>
            <li><a href="SnackBill1.jsp">Snack</a></li>
          </ul>
        </li>
...
<form name="frm1"  method="post" action="UnpaidBooking2.jsp">
    <table id="maintable" align='center'>
                <tr>
                    <td>Select Date</td>
                    <td><input type="date" name="txtdate" placeholder="mm/dd/yyyy" /></td>
                </tr>
                <tr>
                    <td>Select Time</td>
                ...
                <tr>
                    ...
                    <td colspan="2" align='center'><input type="submit" value="View Unpaid" /></td>
