<%-- 
    Document   : login
    Created on : 23 Jun, 2018, 1:17:33 PM
    Author     : Vikas
--%>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <form method="post" action="AuthenticateController" style="max-width:500px;margin:auto">
        <center><h2>Login</h2></center>
  <div class="input-container5">
    <i class="fa fa-user icon"></i>
  <input class="input-field5" type="text" placeholder="Username" name="txtusername" required>
  </div>
  
  <div class="input-container5">
    <i class="fa fa-key icon"></i>
<input class="input-field5" type="password" placeholder="Password" name="txtpassword" required>
  </div>
    ...
    <div>
        <i class="fa fa-user icon"></i>
        <input type="radio" name="cmbusertype" value="2"><b> USER</b>
  
        <input type="radio" name="cmbusertype" value="0"><b> ADMIN </b>   
    
        <input type="radio" name="cmbusertype" value="1"><b> POS</b>
...
<div class="container1">
  ...
  <div class="middle1">
    <div class="text1"><a href="login.jsp">Book</a>
    </div>
  </div>
</div>
  </div>
