<%-- 
    Document   : BookingForm5
    Created on : 1 Jul, 2018, 1:02:28 AM
    Author     : Vikas
--%>
  ...
  <div class="container-fluid">
    ...
    <!--${result}-->
        ...
        <%
            ...
            out.println("<br/>Booking code is: "+session.getAttribute("bookingcode").toString());
            out.println("<br/><h5>Please bring your booking ID/Code at Hall</h5>");
            //out.println("<hr/>");
        ...
        <form name="form1" method="post" action="PaymentController">
            <a href="menu.jsp" target="this.open()"> if pay later then bring booking code and id proof at hall
             before 24 hours of show start time</a>
